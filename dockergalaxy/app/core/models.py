...
class Subcategory(models.Model):
    ...
    scid = models.UUIDField(default=uuid.uuid4, max_length=10)
...
class Product(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name="cat")
    category = models.ForeignKey(
        Category, on_delete=models.SET_NULL, null=True)
    subcategory = models.ForeignKey(
        Subcategory, on_delete=models.SET_NULL, null=True, related_name="subcat")
    ...
    s_stock = models.DecimalField(max_digits=10, default=0, decimal_places=0)
    m_stock = models.DecimalField(max_digits=10, default=0, decimal_places=0)
    l_stock = models.DecimalField(max_digits=10, default=0, decimal_places=0)
    xl_stock = models.DecimalField(max_digits=10, default=0, decimal_places=0)
    xxl_stock = models.DecimalField(max_digits=10, default=0, decimal_places=0)
